...
class CkanTaskDefinitionError(Exception):
    pass


class CkanTaskDefinition(object):


    def __init__(self, AWSAccessKeyId, AWSSecretKey,site_id = 'ckan-demo'):
        super(CkanTaskDefinition, self).__init__()
    ...
    def load_from_config(cls, config_filepath):
        ...
        with open(config_filepath, 'r') as config:
            ...
            return CkanTaskDefinition(**config_data)
    ...
    def create_task_definition(self,config_filepath):
        """
        ...
        os.path.expanduser(
            './config/'+sitename+'/taskdefinition.json'
        )
        )
    ...
    def run(self):
        ...
        self.create_task_definition(config_filepath)
...
if __name__ == '__main__':
    ...
    auto = CkanTaskDefinition.load_from_config(config_filepath)
    try:
        auto.run()
